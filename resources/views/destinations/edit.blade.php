                        ...
                        <div class="mb-6">
                            <label class="block">
                                ...
                                <input type="text" name="name"
                                    ...
                                    placeholder="" value="{{old('name',$destination->name)}}" />
                            </label>
                            @error('name')
                        ...
                        <div class="mb-6">
                            <label class="block">
                                ...
                                <textarea
                                    ...
                                    name="type" rows="3">{{old('type',$destination->type)}}</textarea>
                            </label>
                            @error('type')
                            <div class="flex items-center text-sm text-red-600">
                                {{ $message }}
                        ...
                        <div class="mb-6">
                            <label class="block">
                                ...
                                <textarea
                                    ...
                                    name="location" rows="3">{{old('location',$destination->location)}}</textarea>
                            </label>
                            @error('location')
                            <div class="flex items-center text-sm text-red-600">
                                {{ $message }}
                        ...
                        <div class="mb-6">
                            <label class="block">
                                ...
                                <textarea
                                    ...
                                    name="description" rows="3">{{old('description',$destination->description)}}</textarea>
                            </label>
                            @error('description')
                            <div class="flex items-center text-sm text-red-600">
                                {{ $message }}
